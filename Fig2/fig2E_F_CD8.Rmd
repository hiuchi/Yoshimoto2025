---
title: " Kaplan-Meier curve for CD8 in AC"
output:
  html_document:
    df_print: paged
---
...
# "原本"タブを読み込む
data <- read_excel(file_path, sheet = "AC")
...
km_plot_pfs_no_fill1 <- ggsurvplot(fit_pfs1, data = data,
                                  ...
                                  title = "Progression-free survival in CD8 patterns (AC)",
...
km_plot_OS_no_fill1 <- ggsurvplot(fit_OS1, data = data,
                                  ...
                                  xlab = "Time (OS)",
                                  ylab = "Survival Probability",
                                  title = "Overall survival in CD8 patterns (AC)",
                                  font.main = c(16, "bold"),     # タイトルのサイズを16に、太字に
                                  font.legend = c(16, "bold"))   # 凡例の文字を14に、太字に
...
pdf("Fig2E, F.pdf", width = 6, height = 6)
